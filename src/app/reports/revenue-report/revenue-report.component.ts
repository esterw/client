...
export class RevenueReportComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.subscription = this.service.RevenueReportChanged.subscribe(items => {
      this.RevenueReport = items; this.filteredData = items;
    })
    this.RevenueReport = this.service.RevenueReport;
    this.filteredData = this.service.RevenueReport;
